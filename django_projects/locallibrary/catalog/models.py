...
class Book(models.Model):
    ...
    isbn = models.CharField(_('ISBN'), max_length=13, unique=True, help_text=_('13 Character <a href="https://www.isbn-international.org/content/what-isbn">ISBN number</a>'))
